...
SUB_TRANSLATE = [
    ...
    (r"(?iu)\b(?:ápr\.?|április)(?!\w)", "4月"),
    (r"(?iu)\b(?:máj\.?|május)(?!\w)", "5月"),
    (r"(?iu)\b(?:jún\.?|június)(?!\w)", "6月"),
    (r"(?iu)\b(?:júl\.?|július)(?!\w)", "7月"),
    (r"(?iu)\b(?:aug\.?|augusztus)(?!\w)", "8月"),
    (r"(?iu)\b(?:szept\.?|szeptember)(?!\w)", "9月"),
    (r"(?iu)\b(?:okt\.?|október)(?!\w)", "10月"),
    (r"(?iu)\b(?:nov\.?|november)(?!\w)", "11月"),
    (r"(?iu)\b(?:dec\.?|december)(?!\w)", "12月"),
    (r"hétfő", ""),
    (r"kedd", ""),
    (r"szerda", ""),
    (r"csütörtök", ""),
