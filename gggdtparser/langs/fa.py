...
def _fa_weekday(match, direction):
    day = match.group(1).replace("\u200c", "")
    return "%s%s" % (direction, _FA_WEEKDAYS[day])


SUB_TRANSLATE = [
    (r"(دوشنبه|سه(?:\u200c)?شنبه|چهار(?:\u200c)?شنبه|پنج(?:\u200c)?شنبه|جمعه|شنبه|یک(?:\u200c)?شنبه)\s+(?:آینده|بعد)",
     lambda m: _fa_weekday(m, "下")),
    (r"(دوشنبه|سه(?:\u200c)?شنبه|چهار(?:\u200c)?شنبه|پنج(?:\u200c)?شنبه|جمعه|شنبه|یک(?:\u200c)?شنبه)\s+(?:گذشته|قبل)",
     lambda m: _fa_weekday(m, "上")),
    (r"این\s+(دوشنبه|سه(?:\u200c)?شنبه|چهار(?:\u200c)?شنبه|پنج(?:\u200c)?شنبه|جمعه|شنبه|یک(?:\u200c)?شنبه)",
     lambda m: _fa_weekday(m, "这")),
    (r"دوشنبه", "周一"),
    (r"سه(?:\u200c)?شنبه", "周二"),
    (r"چهار(?:\u200c)?شنبه", "周三"),
    (r"پنج(?:\u200c)?شنبه", "周四"),
    ...
    (r"شنبه", "周六"),
    (r"یک(?:\u200c)?شنبه", "周日"),
    (r"امروز\s+صبح", "今天 08:00 am"),
    (r"امروز\s+ظهر", "今天 12:00 pm"),
    (r"امروز\s+عصر", "今天 17:00 pm"),
    (r"امروز\s+شب", "今天 20:00 pm"),
    (r"فردا\s+صبح", "明天 08:00 am"),
    (r"فردا\s+شب", "明天 20:00 pm"),
    (r"دیشب", "昨天 22:00 pm"),
    (r"ظهر", "12:00 pm"),
    (r"نیمه(?:\u200c)?شب|نیمه\s+شب", "12:00 am"),
