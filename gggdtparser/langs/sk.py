...
SUB_TRANSLATE = [
    ...
    (r"(?iu)\b(?:január|januára)\b", "1月"),
    (r"(?iu)\b(?:február|februára)\b", "2月"),
    (r"(?iu)\b(?:marec|marca)\b", "3月"),
    (r"(?iu)\b(?:apríl|apríla)\b", "4月"),
    (r"(?iu)\b(?:máj|mája)\b", "5月"),
    (r"(?iu)\b(?:jún|júna)\b", "6月"),
    (r"(?iu)\b(?:júl|júla)\b", "7月"),
    (r"(?iu)\b(?:august|augusta)\b", "8月"),
    (r"(?iu)\b(?:september|septembra)\b", "9月"),
    (r"(?iu)\b(?:október|októbra)\b", "10月"),
