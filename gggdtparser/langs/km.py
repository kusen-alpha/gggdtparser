...
_KM_WEEKDAYS = {
    "ចន្ទ": "周一", "ច័ន្ទ": "周一",
    "អង្គារ": "周二", "អង្គាក់": "周二",
    "ពុធ": "周三",
    "ព្រហស្បតិ៍": "周四", "ព្រហស្បតិ៏": "周四",
    "សុក្រ": "周五",
    "សៅរ៍": "周六",
    "អាទិត្យ": "周日",
}
_KM_WEEKDAYS_RE = "|".join(sorted(_KM_WEEKDAYS, key=len, reverse=True))
...
SUB_TRANSLATE = [
    (r"(?:ថ្ងៃ)?(%s)\s*ក្រោយ" % _KM_WEEKDAYS_RE,
     lambda m: "下%s" % _KM_WEEKDAYS[m.group(1)]),
    (r"(?:ថ្ងៃ)?(%s)\s*មុន" % _KM_WEEKDAYS_RE,
    ...
    (r"(?:ថ្ងៃ)?(%s)\b" % _KM_WEEKDAYS_RE,
     lambda m: "周%s" % {
         ...
         "សុក្រ": "五", "សៅរ៍": "六", "អាទិត្យ": "日"}[m.group(1)]),
    (r"ព្រឹកនេះ|ព្រឹកឡើង", "今天 08:00 am"),
    (r"ថ្ងៃត្រង់", "12:00 pm"),
    (r"រសៀលនេះ", "今天 15:00 pm"),
    (r"ល្ងាចនេះ", "今天 20:00 pm"),
    (r"យប់នេះ", "今天 22:00 pm"),
    (r"ព្រឹកស្អែក|ស្អែកព្រឹក", "明天 08:00 am"),
    (r"ល្ងាចស្អែក|ស្អែកល្ងាច", "明天 20:00 pm"),
    (r"ល្ងាចម្សិលមិញ", "昨天 20:00 pm"),
    (r"យប់ម្សិលមិញ", "昨天 22:00 pm"),
    (r"ពាក់កណ្តាលអធ្រាត្រ", "12:00 am"),
    (r"(?<![០-៩])([០-៩]{4})(?![០-៩])",
