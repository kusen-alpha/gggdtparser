...
SUB_TRANSLATE = [
    ...
    (r"(?i)\b(ponedeljek|torek|sreda|sredo|četrtek|petek|sobota|soboto|nedelja|nedeljo)\b",
     lambda m: "周%s" % {
         "ponedeljek": "一", "torek": "二", "sreda": "三", "sredo": "三",
         "četrtek": "四", "petek": "五", "sobota": "六", "soboto": "六",
         "nedelja": "日", "nedeljo": "日"}[m.group(1).lower()]),
    (r"(?i)\b(?:pon\.|tor\.|sre\.|čet\.|četr\.|pet\.|sob\.|ned\.)(?!\w)",
     lambda m: "周%s" % {
         "pon.": "一", "tor.": "二", "sre.": "三", "čet.": "四",
         "četr.": "四", "pet.": "五", "sob.": "六", "ned.": "日"}[
            m.group(0).lower()]),
    (r"(?iu)\b(?:januar|januarja)\b", "1月"),
    (r"(?iu)\b(?:februar|februarja)\b", "2月"),
    (r"(?iu)\b(?:marec|marca)\b", "3月"),
    (r"(?iu)\b(?:april|aprila)\b", "4月"),
    (r"(?iu)\b(?:maj|maja)\b", "5月"),
    (r"(?iu)\b(?:junij|junija)\b", "6月"),
    (r"(?iu)\b(?:julij|julija)\b", "7月"),
    (r"(?iu)\b(?:avgust|avgusta)\b", "8月"),
    (r"(?iu)\b(?:september|septembra)\b", "9月"),
    (r"(?iu)\b(?:oktober|oktobra)\b", "10月"),
    (r"(?iu)\b(?:november|novembra)\b", "11月"),
    (r"(?iu)\b(?:december|decembra)\b", "12月"),
