...
from .zh import _cn_period_hour
...
SUB_TRANSLATE = [
    (r"(?P<part>(?:今天|明天|昨天|前天|后天)(?:凌晨|清晨|早上|早晨|上午|中午|下午|傍晚|晚上|夜里|夜间|深夜)?|今晚|今夜|明晚|昨晚|今早)\s*(?P<H>\d{1,2})\s*[点时點時]\s*(?:(?P<M>\d{1,2})\s*分?|(?P<half>半))?",
     _cn_period_hour),
    (r"(?P<part>凌晨|清晨|早上|早晨|上午|中午|下午|傍晚|晚上|夜里|夜间|深夜|午夜|半夜)\s*(?P<H>\d{1,2})\s*[点时點時]\s*(?:(?P<M>\d{1,2})\s*分?|(?P<half>半))?",
     _cn_period_hour),
