...
SUB_TRANSLATE = [
    ...
    (r"(?i)\b(mánudag(?:ur)?|þriðjudag(?:ur)?|miðvikudag(?:ur)?|fimmtudag(?:ur)?|föstudag(?:ur)?|laugardag(?:ur)?|sunnudag(?:ur)?)\b",
     lambda m: "周%s" % {
         "mánudagur": "一", "mánudag": "一",
         "þriðjudagur": "二", "þriðjudag": "二",
         "miðvikudagur": "三", "miðvikudag": "三",
         "fimmtudagur": "四", "fimmtudag": "四",
         "föstudagur": "五", "föstudag": "五",
         "laugardagur": "六", "laugardag": "六",
         "sunnudagur": "日", "sunnudag": "日"}[m.group(1).lower()]),
    (r"\bjanúar\b", "1月"),
    (r"\bfebrúar\b", "2月"),
    (r"\bmars\b", "3月"),
    (r"\bapríl\b", "4月"),
