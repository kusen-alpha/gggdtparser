...
SUB_TRANSLATE = [
    ...
    (r"(?i)\b(?:aprilie|apr\.?(?!\w))", "4月"),
    (r"(?i)\bmai\.?(?!\w)", "5月"),
    (r"(?i)\b(?:iunie|iun\.?(?!\w))", "6月"),
    (r"(?i)\b(?:iulie|iul\.?(?!\w))", "7月"),
    (r"(?i)\b(?:august|aug\.?(?!\w))", "8月"),
    (r"(?i)\b(?:septembrie|sept\.?(?!\w))", "9月"),
    (r"(?i)\b(?:octombrie|oct\.?(?!\w))", "10月"),
    (r"(?i)\b(?:noiembrie|nov\.?(?!\w))", "11月"),
    (r"(?i)\b(?:decembrie|dec\.?(?!\w))", "12月"),
    (r"(?i)\b(?:ian|feb|mar|apr|mai|iun|iul|aug|sept|oct|nov|dec)\.?(?!\w)",
     lambda m: "%s月" % {
